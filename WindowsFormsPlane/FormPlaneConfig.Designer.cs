namespace WindowsFormsPlane
{
	partial class FormPlaneConfig
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelBomberPlane.MouseDown += new System.Windows.Forms.MouseEventHandler(this.labelPlane_MouseDown);
			// 
			// labelPlane
			// 
			...
			// panelDopColor4
			// 
			this.panelDopColor4.BackColor = System.Drawing.Color.Orange;
